...
namespace BirthDaySign
{
    internal class Program
    {
        ...
        static void Run()
        {
            ...
            SendMail(title, content, topicName, conf.Smtp_Server, conf.Smtp_Port, conf.Smtp_Email, conf.Smtp_Password, conf.Receive_Email_List);
        ...
        static int SendMail(string title, string content, string topicName, string smtp_Server, int smtp_Port, string smtp_Email, string smtp_Password, List<string> receive_Email_List)
        {
